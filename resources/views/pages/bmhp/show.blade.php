...
<div class="modal fade" id="modalFilter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form method="GET" action="{{ route('bmhp-barang') }}">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="barang" id="barang" class="form-control barang" style="width: 100%;">
                            ...
                            <option value="">-- Pilih Barang --</option>
                            @else
                            <option value="{{ $barang }}">{{ $data->where('id_bmhp', $barang)->first()->nama_barang }}</option>
                            @endif
                        </select>
                ...
                <div class="modal-footer">
                    <a href="{{ route('bmhp-barang') }}" class="btn btn-danger btn-sm">
...
<div class="modal fade" id="editModal" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('bmhp-barang.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="col-md-8 my-1">
                                    <input type="text" id="input-id" class="form-control" name="id_bmhp" readonly>
                                </div>
...
<div class="modal fade" id="modal-upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="form-upload" action="{{ route('bmhp-barang.upload') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        function loadTable(kategori, barang, status) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    `);
                        ...
                        // Jika ada data
                        let routeEdit = "{{ route('bmhp-barang.edit', ':id') }}";
                            ...
                            buttons: [{
                                ...
                                userRole == 1 || userRole == 2 ? {
                                    ...
                                    action: function(e, dt, button, config) {
                                        window.location.href = `{{ route('bmhp-barang.create') }}`;
                                    }
                                } : null
                            ].filter(Boolean),
                            "bDestroy": true
            ...
            window.showModal = function(id) {
                $.ajax({
                    url: `{{ url('/bmhp-barang/select/detail/') }}/${id}`,
                    method: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        // Mengisi modal dengan data tamu
                        $('#input-id').val(data.id_bmhp);
                        ...
                        if (data.foto_barang) {
                            $('#modal-foto').attr('src', `{{ asset('dist/img/foto_bmhp/') }}/${data.foto_barang}`)
                        } else {
