                            ...
                            <table id="table" class="table table-bordered text-xs text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('bmhp-stok.detail', $row->id_stok) }}" class="btn btn-default btn-xs bg-primary rounded border-dark">
                                                <i class="fas fa-info-circle p-1" style="font-size: 12px;"></i>
                                            </a>'
                                            <a href="{{ route('bmhp-stok.edit', $row->id_stok) }}" class="btn btn-default btn-xs bg-warning rounded border-dark">
                                                <i class="fas fa-edit p-1" style="font-size: 12px;"></i>
                                            </a>'
                                            <a href="#" class="btn btn-default btn-xs bg-danger rounded border-dark" onclick="confirmLink(event, `{{ route('bmhp-stok.delete', $row->id_stok) }}`)">
