        ...
        <div class="row mb-2">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('bmhp-barang') }}"> Daftar</a></li>
            ...
            <div class="col-md-12 form-group">
                <div class="card card-primary">
                    ...
                    <div class="table-responsive">
                        <form id="form" action="{{ route('bmhp-barang.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body border border-dark">
                                <div class="row">
                                    <div class="col-md-3 text-center mt-5">
                                        @if ($data->foto_barang)
                                        <img id="modal-foto" src="{{ asset('dist/img/foto_bmhp/'. $data->foto_barang) }}" alt="Foto Barang" class="img-fluid">
                                        @else
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 my-1">
                                                <input type="text" id="input-id" class="form-control" name="id_bmhp" value="{{ $data->id_bmhp }}" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-form-label my-1">Jumlah Pcs</div>
                                            <div class="col-md-1 col-form-label my-1">:</div>
                                            <div class="col-md-8 my-1">
                                                <input type="text" id="input-harga" class="form-control number" name="jumlah_pcs" value="{{ $data->jumlah_pcs }}">
                                            </div>
