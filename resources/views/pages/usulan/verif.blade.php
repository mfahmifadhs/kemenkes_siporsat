                        ...
                        <tbody>
                            ...
                            <tr class="bg-white">
                                ...
                                <td class="text-center">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="modal-{{ $row->id_detail }}" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title text-left text-sm">
                                                        {{ $row->atk->nama_barang }}
                                                        <!-- Stok : {{ $row->atk->distribusiAtk($data->pegawai->uker_id)->count().' '.$row->satuan->nama_satuan }} -->
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-2 border-bottom border-dark mb-2 p-2">No</div>
                                                        <div class="col-md-2 border-bottom border-dark mb-2 p-2">Tanggal</div>
                                                        <div class="col-md-5 border-bottom border-dark mb-2 p-2">Distribusi</div>
                                                        <div class="col-md-3 border-bottom border-dark mb-2 p-2">Jumlah</div>
                                                        @foreach ($row->atk->distribusiAtk($data->pegawai->uker_id)->get() as $subRow)
                                                        <div class="col-md-2">{{ $loop->iteration }}</div>
                                                        <div class="col-md-2">{{ $subRow->distribusi->tanggal }}</div>
                                                        <div class="col-md-5">{{ $subRow->distribusi->keterangan }}</div>
                                                        <div class="col-md-3">{{ $subRow->jumlah.' '.$subRow->satuan->nama_satuan }}</div>
                                                        @endforeach

                                                        @if($row->atk->distribusiAtk($data->pegawai->uker_id)->count() == 0)
