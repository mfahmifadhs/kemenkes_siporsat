                ...
                <div class="card-body" style="overflow-y: auto; max-height: 60vh;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" class="form-control" name="judul[]" max="100" placeholder="Contoh : Perbaikan Ruang Rapat" value="{{ $row->judul }}" required>
                        </div>
                        <div class="col-md-3">
                            <label class="col-form-label">Jenis Perbaikan</label>
                            <select name="kategori[]" class="form-control" required>
                                <option value="">-- Pilih Jenis Perbaikan --</option>
                                @foreach($gdn as $subRow)
                                <option value="{{ $subRow->id_gdn }}" <?= $subRow->id_gdn == $row->kategori_id ? 'selected' : ''; ?>>
                                    {{ $subRow->jenis_perbaikan.' - '.$subRow   ->nama_perbaikan }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-9 mb-3">
                            ...
                            <textarea name="uraian[]" class="form-control" rows="10" placeholder="Contoh : Pekerjaan Perbaikan Ruang Rapat" required>{{ $row->uraian }}</textarea>
                        </div>
                    ...
                    <div class="form-group row section-item d-none">
                        ...
                        <div class="col-md-9">
                            <label class="col-form-label">Nama Pekerjaan</label>
                            <input type="text" class="form-control judul" max="100" placeholder="Contoh : Perbaikan Ruang Rapat">
                        </div>
                        <div class="col-md-3">
                            <label class="col-form-label">Jenis Perbaikan</label>
                        ...
                        <div class="col-md-9 mb-3">
                            <label class="col-form-label">Uraian</label>
                            <textarea class="form-control uraian" rows="10" placeholder="Contoh : Pekerjaan Perbaikan Ruang Rapat"></textarea>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="col-form-label">Keterangan</label>
