        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('usulan', 'bmhp') }}">Daftar</a></li>
            ...
            <div class="card-body small">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-center">
                        ...
                        <tbody>
                            @foreach($data->detailBmhp as $index => $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn btn-default btn-xs bg-danger rounded" onclick="confirmRemove(event, `{{ route('usulan-bmhp.delete', $row->id_detail) }}`)">
                                    ...
                                    <div class="modal fade text-left" id="editItem-{{ $row->id_detail }}" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form id="form-edit-{{ $row->id_detail }}" action="{{ route('usulan-bmhp.update') }}" method="POST">
                                                    @csrf
...
<div class="modal fade" id="tambahItem" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form-add" action="{{ route('usulan-bmhp.store') }}" method="POST">
                @csrf
                <input type="hidden" name="usulan_id" value="{{ $data->id_usulan }}">
                <div class="modal-body">
                    <div class="form-group">
