                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="info-box mb-3 border border-dark" style="background-color: #F0A04B;">
                                ...
                                <div class="info-box-content">
                                    <h3 class="info-box-number">{{ $usulan->where('form_id', 6)->count() }}</h3>
                                            ...
                                            <li class="nav-item">
                                                <form action="{{ route('usulan', 'bmhp') }}" method="GET">
                                                    ...
                                                    <button type="submit" class="nav-link btn btn-link py-2 font-weight-bold text-left btn-block">
                                                        ...
                                                        <span class="float-right">
                                                            {{ $usulan->where('form_id', 6)->whereNull('status_persetujuan')->count() }}
                                                            usulan
                                                        </span>
                                                    </button>
                                                </form>
                                            ...
                                            <li class="nav-item">
                                                <form action="{{ route('usulan', 'bmhp') }}" method="GET">
                                                    ...
                                                    <button type="submit" class="nav-link btn btn-link py-2 font-weight-bold text-left btn-block">
                                                        ...
                                                        <span class="float-right">
                                                            {{ $usulan->where('form_id', 6)->where('status_proses', 'proses')->count() }}
                                                            usulan
                                                        </span>
                                                    </button>
                                                </form>
                                            ...
                                            <li class="nav-item">
                                                <form action="{{ route('usulan', 'bmhp') }}" method="GET">
                                                    ...
                                                    <button type="submit" class="nav-link btn btn-link py-2 font-weight-bold text-left btn-block">
                                                        ...
                                                        <span class="float-right">
                                                            {{ $usulan->where('form_id', 6)->where('status_proses', 'selesai')->count() }}
                                                            usulan
                                                        </span>
                                                    </button>
                                                </form>
                                            ...
                                            <li class="nav-item">
                                                <form action="{{ route('usulan', 'bmhp') }}" method="GET">
                                                    ...
                                                    <button type="submit" class="nav-link btn btn-link py-2 font-weight-bold text-left btn-block">
                                                        ...
                                                        <span class="float-right">
                                                            {{ $usulan->where('form_id', 6)->where('status_persetujuan', 'false')->count() }}
                                                            usulan
                                                        </span>
                                                    </button>
                                                </form>
