...
<div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form" action="{{ route('atk-kategori.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="editModal-{{ $row->id_kategori }}" aria-labelledby="editModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formUpdate-{{ $row->id_kategori }}" action="{{ route('atk-kategori.update', $row->id_kategori) }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <div class="mb-3">
