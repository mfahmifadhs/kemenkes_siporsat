...
<section class="content">
    <div class="container col-md-9">
        <div class="card border border-dark">
            ...
            <form id="form-submit" action="{{ route('atk-stok.update', $data->id_stok) }}" method="POST">
                @csrf
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="" class="btn btn-default btn-xs bg-danger rounded" onclick="confirmRemove(event, `{{ route('atk-stok.item.delete', ['aksi' => 'stok', 'id' => $row->id_detail]) }}`)">
                                        ...
                                        <div class="modal fade text-left" id="editItem-{{ $row->id_detail }}" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form id="form-edit-{{ $row->id_detail }}" action="{{ route('atk-stok.item.update', $row->id_detail) }}" method="POST">
                                                        @csrf
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control text-center w-25 ml-2 satuan" value="{{ $row->atk->satuan->nama_satuan }}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <td>{{ $row->atk->satuan->nama_satuan }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
...
<div class="modal fade" id="tambahItem" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form-add" action="{{ route('atk-stok.item.store') }}" method="POST">
                @csrf
                <input type="hidden" name="stok_id" value="{{ $data->id_stok }}">
                <div class="modal-body">
                    <div class="form-group">
